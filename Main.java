...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Kamar berhasil dibuat:");
        kamar001.infoKamar();
        System.out.println();
        
        // Membuat Pegawai
        System.out.println("\n--- INISIALISASI PEGAWAI ---");
        Resepsionis resepsionis1 = new Resepsionis("P001", "Azka", "Medan", "azkagantengbanget123@gmail.com");
        Housekeeping housekeeping1 = new Housekeeping("H001", "Budi", "Jakarta", "budi.cleaning@gmail.com");
        
        System.out.println("Pegawai berhasil dibuat:");
        System.out.println("Resepsionis:");
        resepsionis1.tunjukkanData();
        ...
        System.out.println("\n--- MENAMBAH PESANAN ---");
        PesananKamar nota3 = new PesananKamar(pelanggan2, "P003", LocalDate.now(), LocalDate.now().plusDays(2), "Ongoing", new ArrayList<>());
        pelanggan2.setDaftarPesanan(nota3);
        pelanggan2.tambahPesanan(kamar003);
        pelanggan2.tambahPesanan(kamar004);
        System.out.println("Pesanan setelah penambahan:");
        pelanggan2.infoPelanggan();
        
        // Simulasi Housekeeping untuk Pelanggan 2
        System.out.println("\n--- PROSES HOUSEKEEPING PELANGGAN 2 ---");
        // Menambahkan kamar ke daftar tugas housekeeping
        List<Kamar> tugasKamar2 = new ArrayList<>();
        tugasKamar2.add(kamar003);
        tugasKamar2.add(kamar004);
        housekeeping1.setDaftarKamarTugas(tugasKamar2);
        
        System.out.println("Status kamar sebelum dibersihkan:");
        kamar003.infoKamar();
